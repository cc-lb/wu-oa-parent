...
export default {
  data() {
    return {
      ...
      fileList: [],
       array:['application/x-zip', 'application/zip', 'application/x-zip-compressed','application/octet-stream']
    }
  },
  ...
  methods: {
    ...
    // 文件上传限制条件
    beforeUpload(file) {
      const isZip = file.type === 'application/x-zip-compressed'||'application/x-zip'||'application/zip'||'application/x-zip-compressed'||'application/octet-stream'
    ...
    onUploadSuccess(res, file) {
      ...
      //console.log(this.processTemplate)
