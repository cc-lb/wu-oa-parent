...
import com.wu.security.filter.TokenAuthenticationFilter;
import com.wu.security.filter.TokenLoginFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/admin/system/index/login","/admin/system/index/register").permitAll()
                // 这里意思是其它所有接口需要认证才能访问
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        //,"/admin/wechat/authorize","/admin/wechat/userInfo","/admin/wechat/bindPhone","/admin/modeler/**","/diagram-viewer/**","/editor-app/**","/*.html",
        //"/admin/processImage/**");
